                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    $id = $_SESSION['id'];
                                        ...
                                        u.ulb_company_id = '$id' and s.status = 2  where m.company_id='$id' order by posted_on";
                                        ...
                                        <td>
                                            <form action="./src/php/main.php" method="post">
                                                ...
                                                <a href="./user_profile_student.php?studentid=<?php echo $row['student_uid']?>"
                                                    style="background-color:#b4c13e" class="btn btn-sm">
                                                    View Profile
                                                </a>
