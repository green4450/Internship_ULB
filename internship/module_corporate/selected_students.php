                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    $id = $_SESSION['id'];
                                        ...
                                        u.ulb_company_id = '$id' and s.status = 3  where m.company_id='$id' order by posted_on";
                                        ...
                                        <td>
                                            <form action="./src/php/main.php" method="post">
                                                ...
                                                <a href="./user_profile_student.php?uid=<?php echo $row['student_uid'];?>" class="btn btn-sm btn-info" target="_blank" style="background-color:#b4c13e">View Profile</a>
                                                <button type="button" class="btn btn-sm btn-info"
                                                    id="trigger<?php echo $row['student_uid'];?>">
                                                    View Offer Letter
                                                </button>
                                                <div id="dialog<?php echo $row['student_uid'];?>" style="display:none">
                                                    <div>
                                                        <iframe style="width:800px; height:500px;"
                                                            src="../uploads/offer/<?php echo $row['student_uid'].$_SESSION['organisation'];?>.pdf"></iframe>
                                                    </div>
                                                </div>
                                                <script language="javascript" type="text/javascript">
                                                $(document).ready(function() {
                                                    $("#trigger<?php echo $row['student_uid'];?>").click(
                                                        function() {
                                                            $("#dialog<?php echo $row['student_uid'];?>")
                                                                .dialog();
                                                        });
                                                });
                                                </script>
                                               
                                                <button type="submit" class="btn btn-sm btn-danger" id="hold"
                                                    name="hold">
                                                    Put on Waitlist
                                                </button>
                                                <button type="submit" class="btn btn-sm btn-danger" id="reject"
                                                    name="reject">
                                                    Reject The Applicants
                                                </button>
                                                <?php if($row['status'] == 4){?>
                                                <button type="button" class="btn btn-sm btn-info" data-toggle="modal"
                                                    data-target="#exampleModalCenter">View Certificate</button>
                                                <?php  }else{?>
                                                <button type="button" class="btn btn-sm btn-success" data-toggle="modal"
                                                    data-target="#exampleModal5<?php echo $row['student_uid'] ?>">Release
                                                    Certificate</button>
                                                <?php }?>
                                            </form>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body" style="width:auto">
                                                                <div class="container" style="width: 450px;">
                                                                    ...
                                                                    <div class="modal-footer" id="exampleModalLabel">
                                                                        <button type="submit" id="called_for_interview"
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer" id="exampleModalLabel">
                                                                ...
                                                                <button type="submit" id="reject_reason"
                                                                    name="reject_reason" class="btn btn-success">Save
                                                                    changes</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer" id="exampleModalLabel">
                                                                ...
                                                                <button type="submit" id="certificate_gen"
                                                                    name="certificate_gen" class="btn btn-success">Save
                                                                    changes</button>
                                                            </div>
