            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="card">
                        ...
                        <?php 
                      $sql = "SELECT student_first_name,student_last_name,student_course,student_stream,a.student_uid,internship_uid,u.ulb_organisaton FROM student_register r INNER JOIN government_internship_apply a on a.student_uid = r.student_uid inner join ubl_register u on u.ulb_company_id = a.company_id and a.status = 'completed'";
                      ...
                      while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr>
                          ...
                          ?>
                        <button type="button" class="btn btn-sm btn-info" id="trigger<?php echo $row['student_uid'];?>">
                            View Certificate
                        </button>
                        ...
                        $(document).ready(function() {
                            $('#trigger<?php echo $row['student_uid'];?>').click(function() {
                                $("#dialog<?php echo $row['student_uid'];?>").dialog();
                            });
                        });
                        </script>
                        <?php '
