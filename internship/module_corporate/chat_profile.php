                        ...
                        <div class="headind_srch">
                            ...
                            <div class="dropdown">
                                <select class="form-control" name="id2" id="id2">
                                    ...
                                    <option value="automatched">Automatched</option>
                                </select>
                            </div>
...
$query_status = mysqli_real_escape_string($conn,$_POST['id1']);
				...
				$sql="SELECT student_uid,student_first_name from student_register s inner join internhip_apply m on m.student_uid = s.student_uid where  m.status = 2   ";
			...
			echo '
              ...
              <div class="chat_people">
                ...
                <div class="chat_ib">
                  ...
                  <a href="student_select.php?uid='.$row['student_uid'].'company_id='.$_SESSION['id'].'&user='.$_SESSION['user'].'">
