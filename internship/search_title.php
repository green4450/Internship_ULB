...
<section id="search-bar">
                <div class="form-group">
                    <div class="autocomplete">
                        <input id="title" name="title" class="form-control border border-dark" style="width: 300px" type="search" name="location" placeholder="Titte" required>
                    </div>
                </div>
</section>
<?php 
$sql = "SELECT Distinct title FROM post_internship_government";
