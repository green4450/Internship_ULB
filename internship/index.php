                            ...
                            <div class="col-md-4 d-flex justify-content-center counter-wrap ftco-animate">
                                <div class="block-18">
                                    <div class="text d-flex">
                                        <div class="icon mr-2">
                                            <span class="flaticon-worldwide"
                                                style="font-size:34px;margin-top:13px"></span>
                                        </div>
                                        <?php
                    ...
                    <div class="row no-gutters">
                        <div class="col-md-2">
                            <div class="top-category text-center no-border-left">
                                <h3><a href="./fetch_ubl.php">Urban Local Body/Smart Cities</a></h3>
                        ...
                        <div class="col-md-2">
                            <div class="top-category text-center">
                                <h3><a href="./internship.php">NHAI</a></h3>
                        ...
                        <div class="col-md-2">
                            <div class="top-category text-center">
                                <h3><a href="#">Virtual/Offline</a></h3>
                                <span class="icon flaticon-idea"></span>
                                <p><span class="number">143</span> <span>Open position</span></p>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="col-md-3 ftco-animate">
                <ul class="category text-center">
                    <li><a href="#">Company <br><span class="number">354</span> <span>Open
                                position</span><i class="ion-ios-arrow-forward"></i></a></li>
                    <li><a href="#">Category <br><span class="number">100</span> <span>Open
                                position</span><i class="ion-ios-arrow-forward"></i></a></li>
                    <li><a href="#"> Woman<br><span class="number">90</span> <span>Open
                                position</span><i class="ion-ios-arrow-forward"></i></a></li>
                </ul>
            </div>
            <div class="col-md-3 ftco-animate">
                <ul class="category text-center">
                    <li><a href="fetch_ubl.php">Urban Local Body/Smart Cities<br><span class="number">354</span> <span>Open
                                position</span><i class="ion-ios-arrow-forward"></i></a></li>
            ...
            <div class="col-md-3 ftco-animate">
                <ul class="category text-center">
                    <li><a href="internship.php">Internshala<br><span class="number">354</span> <span>Open
                                position</span><i class="ion-ios-arrow-forward"></i></a></li>
...
<section class="ftco-section" style="background-color:#f1f0f0">
    <div class="container">
        <div class="row justify-content-center mb-5">
            <div class="col-md-7 heading-section text-center ftco-animate">
                <h2 style="">Internship in Popular Cities</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-md-3 ftco-animate">
                <ul class="category text-center">
                    <li><a href="#">Delhi <br><span class="number">354</span> <span>Open
                                position</span><i class="ion-ios-arrow-forward"></i></a></li>
            ...
            <div class="col-md-3 ftco-animate">
                <ul class="category text-center">
                    <li><a href="fetch_ubl.php">Uttrakhand<br><span class="number">354</span> <span>Open
                                position</span><i class="ion-ios-arrow-forward"></i></a></li>
                </ul>
            </div>
            <div class="col-md-3 ftco-animate">
                <ul class="category text-center">
                    <li><a href="internship.php">Goa<br><span class="number">354</span> <span>Open
                                position</span><i class="ion-ios-arrow-forward"></i></a></li>
            ...
            <div class="col-md-3 ftco-animate">
                <ul class="category text-center">
                    <li><a href="#">Lucknow <br><span class="number">143</span> <span>Open
                                position</span><i class="ion-ios-arrow-forward"></i></a></li>
...
/*         $sql = "SELECT Distinct title,city,country,salary,StartDate,company,working_hours,url FROM tblipinternshala WHERE company LIKE '%$company%' and working_hours LIKE '%$category%' and city LIKE '%$location%';";
				   ...
				   $sql = "SELECT uid,title,internship_type,locations,ulb_organisaton,posted_on,stiphen FROM post_internship_government g inner join ubl_register a ON a.ulb_company_id = g.company_id ORDER BY `g`.`posted_on` ASC ;";
				   $res = mysqli_query($conn,$sql);
				   while($row = mysqli_fetch_assoc($res))
				   {
                    echo'<div class="col-md-12 ftco-animate" style="overlay:hidden">
            ...
            <div class="col-lg-3 sidebar">
                ...
                <div class="sidebar-box ftco-animate">
                    <div class="">
                        <a href="#" class="company-wrap"><img src="./assets/images2/company-1.jpg"
                                class="img-fluid"></a>
                        <div class="text p-3">
                ...
                <div class="sidebar-box ftco-animate">
                    <div class="">
                        <a href="#" class="company-wrap"><img src="./assets/images2/company-2.jpg"
                                class="img-fluid"></a>
                        <div class="text p-3">
                ...
                <div class="sidebar-box ftco-animate">
                    <div class="">
                        <a href="#" class="company-wrap"><img src="./assets/images2/company-3.jpg"
                                class="img-fluid"></a>
                        <div class="text p-3">
                ...
                <div class="sidebar-box ftco-animate">
                    <div class="">
                        <a href="#" class="company-wrap"><img src="./assets/images2/company-4.jpg"
                                class="img-fluid"></a>
                        <div class="text p-3">
                            <h3><a href="#">IT Programming INC</a></h3>
                            <p><span class="number">700</span> <span>Open position</span></p>
...
<!-- <section class="ftco-section bg-light">
    ...
    <section class="ftco-section-parallax subscribeNowDivNew">
      <div class="parallax-img d-flex align-items-center newsbusDiv">
        <div class="container">
        	<div class="modijIMantriJiDivR">
        		<img src="./assets/images3/mantriJiModiJi.png">
        	</div>  
        	<div class="modijIMantriJiDivCntL">
        		<div class="keyAnnounceDiv">
        		<h2>Key Announcements For Indian Students</h2>
        		<ul>
        			<li><i class="fa fa-circle" aria-hidden="true"></i> Internships for  students & fresh engineers</li>
        			<li><i class="fa fa-circle" aria-hidden="true"></i> From job seekers to job creators</li>
        			<li><i class="fa fa-circle" aria-hidden="true"></i> Rs 99,300 crore for Education sector in 2020-21</li>
        			<li><i class="fa fa-circle" aria-hidden="true"></i> Apprenticeship embedded courses</li>
        			<li><i class="fa fa-circle" aria-hidden="true"></i> Online education programmes for students</li>
        			<li><i class="fa fa-circle" aria-hidden="true"></i> Financing Education Sector [FDI, External commercial borrowing]</li>
        		</ul>
        	</div>
