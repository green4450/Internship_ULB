            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active"><a href="add_courses.php">Courses And Stream Management</a>
                        </li>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                <input class="form-control" type="text" id="departemnt" name="departemnt"
                                    placeholder="Role">
                            </div>
                        </div>
                        <div class="col">
