                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-field">
                                                            ...
                                                            <input type="text" id="company" name="company"
                                                                ...
                                                                style="width:300px" placeholder="Title Of Internship">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md mr-md-2">
                    ...
                    <div class="row no-gutters">
                        <div class="col-md-2">
                            <div class="top-category text-center no-border-left">
                                <h3><a href="./fetch_ubl.php">Internship By Urban Local Bodies</a></h3>
                        ...
                        <div class="col-md-2">
                            <div class="top-category text-center">
                                ...
                                <span class="icon flaticon-acoounting"></span>
                                <p><span class="number">143</span> <span>Problems</span></p>
                            </div>
                        </div>
                        <div class="col-md-2">
...
<section class="ftco-section bg-light" style="background-color:#f1f0f0">
 ...
 $allcount_query = "SELECT count(*) as allcount FROM tblipinternshala";
 $allcount_result = mysqli_query($conn,$allcount_query);
 $allcount_fetch = mysqli_fetch_array($allcount_result);
 $allcount = $allcount_fetch['allcount'];

 // select first 3 posts
 $query = "select * from tblipinternshala where title like '%$company%' and city like '%$location%' and working_hours like '%$category%' order by id DESC limit 0,$rowperpage ";
    ...
    <div class="job-post-item rounded p-4 d-block d-lg-flex align-items-center">
        <div class="one-third mb-4 mb-md-0">
            <div class="job-post-item-header align-items-center">
                ...
                <span class="subadge" style="margin-left:120px">'.$row['working_hours'].'</span>
            ...
            <center>
            /* <a data-toggle="modal" data-target="#exampleModal'.$row['id'].'" href="'.$row['url'].'" class="btn btn-view">View Internship Detail</a> */
            </center>
        </div>
    </div>
</div>
...
// select first 3 posts
$query = "select * from tblipinternshala order by id DESC limit 0,$rowperpage ";
$result = mysqli_query($conn,$query);
