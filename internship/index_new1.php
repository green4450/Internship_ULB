        ...
        <div class="row d-md-flex no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-10 d-flex align-items-center ftco-animate">
                <div class="text text-center pt-5 mt-md-5 _newTpDiv">
                    <div class="ftco-counter ftco-no-pt ftco-no-pb _newTDivTotalC">
                        <div class="row">
...
<section class="ftco-section ftco-no-pt ftco-no-pb _sectionNew" >
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="row no-gutters">
                        <div class="col-md-2">
                            <div class="top-category text-center no-border-left">
                                <h3><a href="./fetch_ubl.php">Internship By ULB</a></h3>
                        ...
                        <div class="col-md-2">
                            <div class="top-category text-center">
                                <h3><a href="./internship.php">Internship By Internshala</a></h3>
...
<section class="ftco-section _interbyCatSec" style="background-color:#f1f0f0">
    <div class="container">
...
<section class="ftco-section bg-light _interbyCatSec_1" style="background-color:#f1f0f0">
    <div class="container">
        <div class="row">
            <div class="col-lg-9 pr-lg-5">
                ...
                <div class="row">
                    <div class="_resultDivnew" id="result">
                        <?php 
         ...
         echo'<div class="col-md-12 ftco-animate" style="overlay:hidden">
             <div class="job-post-item rounded p-4 d-block d-lg-flex align-items-center">
                 <div class="one-third mb-4 mb-md-0">
                     ...
                     <a href="./login_type.php" style="background-color: #24E0DD;" class="btn btn-apply  py-2">Apply Internship</a>

                     <a href="Detail_profile.php?uid='.$row['uid'].'" class="btn btn-view py-2">View Details</a>
                 </div>
...
<section class="ftco-section-parallax _interbyCatSec_2">
...
function googleTranslateElementInit() {
  new google.translate.TranslateElement({pageLanguage: 'en'}, 'navBtmLangC');
}
</script> 