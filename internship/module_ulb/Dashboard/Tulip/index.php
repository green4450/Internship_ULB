...
<head>
    ...
    <body class="demo-5">
						...
						<div class="row">
							<div class="col-md-9">
								...
								<ul class="dl-menu">
									   ...
									   <li><a href="window.print()">Download as Excel/PDF</a></li> 
                       ...
                       echo $row['total'];
						...
						<div class="col-md-4 col-sm-4">
							<div class="city_award_list  text-center">
								...
								<h3>
                                                                <?php
                $sql = "SELECT count(*) as total From post_internship_government g inner join government_internship_apply a  on g.uid = a.internship_uid and a.status = 3";
                $res = mysqli_query($conn,$sql);
                while($row = mysqli_fetch_assoc($res))
                {                       
                       echo $row['total'];
						...
						<div class="col-md-4 col-sm-4">
							<div class="city_award_list  text-center">
								...
								<h3>
                                                                <?php
                $sql = "SELECT count(*) as total From post_internship_government g inner join government_internship_apply a  on g.uid = a.internship_uid and a.status ='completed'";
                $res = mysqli_query($conn,$sql);
                while($row = mysqli_fetch_assoc($res))
                {                       
                       echo $row['total'];
						...
						<div class="col-md-3 col-sm-3">
                         <div class="city_request_list">
								...
								<div class="city_request_link">
									<ul>
									<?php
									$sql="select state , count(*) as total from post_internship_government where internship_status = 'On Going' group by state order by total";
									$res = mysqli_query($conn,$sql);
									while($row = mysqli_fetch_assoc($res)){
										echo  
										'<li><a href="#" class="pull-left" >'.$row['state'].'</a> <span class="pull-right pointer" data-toggle="tooltip" title="Posted" alt="posted" > (3)</span><span class="pull-right pointer" data-toggle="tooltip" title="Posted" alt="posted" > (0)</span><span class="pull-right pointer" data-toggle="tooltip" title="Posted" alt="posted" > (5)</span></li>';
									}
										?> 
                                        <a href="#" tabindex="-1">View All Cities <i class="fa fa-angle-double-right"></i></a>
									</ul>
								</div>
							</div>
                        ...
                        <iframe scrolling="no" frameborder="0" src="embed.html" style="width: 100%; height:700px "></iframe>
                         ...
                         <div class="city_request_list">
								...
								<div class="city_request_link">
									<ul>
									<?php
									$sql="SELECT locations from post_internship_government limit 10";
									$res = mysqli_query($conn,$sql);
									while($row = mysqli_fetch_assoc($res)){
										echo  
										'<li><a href="#" class="pull-left" >'.$row['locations'].'</a> <span class="pull-right pointer" data-toggle="tooltip" title="Posted" alt="posted" > (3)</span><span class="pull-right pointer" data-toggle="tooltip" title="Posted" alt="posted" > (0)</span><span class="pull-right pointer" data-toggle="tooltip" title="Posted" alt="posted" > (5)</span></li>';
									}
										?>  
                                        <a href="#" tabindex="-1">View All Cities<i class="fa fa-angle-double-right"></i></a>
									</ul>
     ...
     <option value="city-map/west-bengal.svg">West Bengal</option>
                        ...
                        <select>  
					<?php 
					$sql = "SELECT ulb_organisation FROM ubl_register";
					$res = mysqli_query($conn,$sql);
					while($row = mysqli_fetch_assoc($res)){
						echo 
	 '<option value="'.$row['ulb_oganisation'].'">'.$row['ulb_oganisation'].'</option>';
					}
	 ?>
    </select>
    					</div>
                           ...
                           <div class="text-center  ">	<h5 style="margin-top:20px;">Lucknow Muncipal Corporation</h5><img src="extra-images/city-logo.jpg" alt="" width="250"></div>
						 </div>
						 <div class="col-md-3 col-sm-3">
                         <div class="city_request_list margin-bottom">
								<div class="city_request_row">
