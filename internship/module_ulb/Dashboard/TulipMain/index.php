...
<head>
  ...
  <tr>
        ...
        <tr>
         <td colspan="4" align="left"><a href="#" >View All States &raquo;</a></td>
                         ...
                         <div class="city_request_list">
								<div class="city_request_row">
									 <div class="city_request_text">
										...
										<h4>Top 10 ULBs / Smart Cities</h4>
                                       <!-- <span>View More</span>-->
									</div>
								</div>
								<div class="city_request_link">
  ...
  <tr>
    ...
    <tr >
               ...
               <!-- <div class="city_request_list margin-bottom">
					 ...
					 <div class="city_award_list  text-center  margin-bottom">
                                ...
                                <h4>COMPLETED</h4>
															...
															<h3>
                                                                <?php
                $sql = "SELECT count(*) as total From post_internship_government g inner join government_internship_apply a on g.uid = a.internship_uid and a.status ='completed' and g.state = 'Uttar Pradesh' ";
                $res = mysqli_query($conn,$sql);
                while($row = mysqli_fetch_assoc($res))
                {                       
                       echo $row['total'];
							...
							<div class="city_award_list  text-center  margin-bottom">
								...
								<h3>
                                                                <?php
                $sql = "SELECT count(*) as total From post_internship_government g inner join government_internship_apply a  on g.uid = a.internship_uid and a.status = 4 and g.state = 'Uttar Pradesh'";
                $res = mysqli_query($conn,$sql);
                while($row = mysqli_fetch_assoc($res))
                {                       
                       echo $row['total'];
                            ...
                            <div class="city_award_list text-center margin-bottom">
								...
								<h3>
                                                                <?php
                $sql = "SELECT count(*) as total From post_internship_government g Where g.state = 'Uttar Pradesh' ";
                $res = mysqli_query($conn,$sql);
                while($row = mysqli_fetch_assoc($res))
                {                       
                       echo $row['total'];
     ...
     <option value="city-map/west-bengal.svg">West Bengal</option>
                        ...
                        <select>
                                                                <?php
                $sql = "SELECT ulb_organisaton,ulb_logo From ubl_register";
                $res = mysqli_query($conn,$sql);
                while($row = mysqli_fetch_assoc($res))
                {                       
							...
							<div class="widget_copyright">
								...
								<div class="col-md-6">
									<div class="copyright_text">
										<p><span>Copyright © 2018 - 19 TULIP .</span> Designed and Developed by NIC And AICTE</p>
									</div>
								</div>
								<div class="col-md-3 col-sm-6">
									<div class="city_top_social">
