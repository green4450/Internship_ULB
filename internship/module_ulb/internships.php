...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Total Posted Internships</h1>
                </div>
                <div class="col-sm-6">
              ...
              ?>
                      ...
                      while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr>
                          ...
                          <td>
                              <a href="./workspace.php?uid='.$row['uid'].'" class="btn btn-sm btn-success">
                                  Go to Workspace
                              </a>
                          </td>
                          <td>
                          <form action="./src/php/main.php" method="post">
                                ...
                                <button type="submit" class="btn btn-sm btn-danger" id="new" name="new">
                                  Delete
                                </button>
                            </form>
                          </td>
                        ...
                        <?php }else
                    {
                      ...
                      while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr>
                          ...
                          <form action="./src/php/main.php" method="post">
                          <input type="hidden" id="uid" name="uid" value="'.$row['uid'].'">
                          <button type="submit" class="btn btn-sm btn-danger" id="delete_internship" name="delete_internship">
                            Delete
                          </button>
                      </form>
                          </td>
