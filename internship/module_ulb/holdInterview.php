    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <?php 
            ...
            $sql = "SELECT * FROM internhips WHERE student_id = '$uid';";
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                $sql = "UPDATE internhip_apply SET status = 'Internship On Hold' WHERE student_uid = '$stuId' AND internship_uid = '$uid';";
