...
<div class="content-wrapper">
    ...
    <div class="content-header">
        ...
        <label for="" style="">Select Urbal local body</label>
       
        <div class="form-group">
            <select multiple class="form-control" name="prog" id="prog">
                <option value="ALL Over India ULB's">ALL Over India ULB's</option>
                <option value="ALL Over India ULB's">Urban local body 1</option>
                <option value="ALL Over India ULB's">Urban local body 2</option>
                <option value="ALL Over India ULB's">Urban local body 3</option>
                <option value="ALL Over India ULB's">Urban local body 4</option>
            </select>
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
        ...
        <div class="card card-success">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="chart">
                        <img src="../assets/images1/new.png" alt="">
                    </div>
                </div>
            </div>
...
<div class="row">
    <div class="col">
        ...
        <div class="form-group">
            <select class="form-control w-25" name="prog[]" id="prog">
    ...
    <img src="../assets/images1/new.png">
</div>
<div class="row">
            <div class="col">
                <label for="" style="">Department</label>
                <div class="form-group">
